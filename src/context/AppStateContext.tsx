...
const DEFAULT_TENANT_BRAND_COLORS: [string, string, string] = ['#F8F9FA', '#FFFFFF', '#111111'];
...
function normalizeTenantBranding(branding?: Partial<TenantBrandingProfile>): TenantBrandingProfile {
  ...
  return {
    ...
    accentSecondary: branding?.accentSecondary ? normalizeHexColor(branding.accentSecondary, '#111111') : undefined,
    ...
    surfaceColor: branding?.surfaceColor ? normalizeHexColor(branding.surfaceColor, '#FFFFFF') : undefined,
